...
namespace GOTHIC_ENGINE {
  ...
  void Game_Init() {
    ...
    if (parser) {
      ...
      SE_MarkDllLoaded_G2A();

      parser->CallFunc(zSTRING("SE_RestoreJinaAutoReviveFromPersist"));
      parser->CallFunc(zSTRING("SE_RestoreWolfPackFromPersist"));
  ...
  void Game_DefineExternals() {
    ...
    SE_DefineSummonBarExternals_G2A();
